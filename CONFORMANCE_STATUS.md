...
| PROVIDER-001B Responses decode-to-replay slice | PENDING | Requires post-actuality decoding of a successful valid-shaped response, preservation of every completion, independent support admission, capture-safe binding, resumption, and zero-redispatch restart reconstruction with distinct failure exits. |
