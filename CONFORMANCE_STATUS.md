...
| P4-DEPARTURE-STAND-001 shared departure support and source-presentation claim target must occur in declared least-fixed-point standing | PASS | `decoder_identity::departure_witness_requires_its_shared_source_presentation_support_to_stand`; `relation_schema::departure_witness_check_requires_the_declared_presentation_and_context` |
