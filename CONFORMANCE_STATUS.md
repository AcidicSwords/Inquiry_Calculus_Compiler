...
| PROVIDER-001C typed decode-to-replay slice | PENDING | Requires deterministic typed candidate materialization from a stored valid-shaped response, independent support admission, capture-safe binding, resumption, and zero-redispatch restart reconstruction without reusing pre-crash derived objects. |
