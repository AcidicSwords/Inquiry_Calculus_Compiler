...
| Positive standing, support environments, and rootless cycles | PARTIAL | Phase 11: canonical claim identity/provenance checking, least-fixed-point standing over derived declared support environments, the five closed-support conditions, and the no-rootless-cycle theorem pass; canonical support-environment identity and connection to the SupportRef fields carried elsewhere remain pending |
