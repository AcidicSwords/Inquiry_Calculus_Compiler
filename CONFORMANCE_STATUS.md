...
| PROVIDER-001D typed decode-to-replay slice | PENDING | Requires typed forms and completion candidates over every regenerated value, independent support admission, capture-safe binding, resumption, and zero-redispatch restart reconstruction without reusing pre-crash derived objects. |
