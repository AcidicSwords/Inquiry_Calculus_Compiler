...
const required = [
  ...
  "formal-successor/PHASE_B_TAGGED_NEGATION_FRONTIER_SCHEMA.json",
  "formal-successor/PHASE_B_TAGGED_NEGATION_FRONTIER_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/TaggedNegationFrontier.lean",
  "formal-successor/PHASE_B_USE_SPECIFIC_RETURN_FIBER_SCHEMA.json",
  "formal-successor/PHASE_B_USE_SPECIFIC_RETURN_FIBER_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/UseSpecificReturnFiber.lean",
  "formal-successor/PHASE_B_PROTECTED_RECOVERY_SCHEMA.json",
  "formal-successor/PHASE_B_PROTECTED_RECOVERY_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ProtectedRecovery.lean",
  "formal-successor/PHASE_B_SOURCE_WEB_RECOVERY_PROFILE_SCHEMA.json",
  "formal-successor/PHASE_B_SOURCE_WEB_RECOVERY_PROFILE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/SourceWebRecoveryProfile.lean",
  "formal-successor/PHASE_B_THREE_VALUED_RECOVERY_LOSS_PROFILE_SCHEMA.json",
  "formal-successor/PHASE_B_THREE_VALUED_RECOVERY_LOSS_PROFILE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ThreeValuedRecoveryLossProfile.lean",
  "formal-successor/PHASE_B_REGENERATIVE_ECONOMY_FRONTIER_SCHEMA.json",
  "formal-successor/PHASE_B_REGENERATIVE_ECONOMY_FRONTIER_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/RegenerativeEconomyFrontier.lean",
  "formal-successor/PHASE_B_REQUIRED_DISCHARGE_SCHEMA.json",
  "formal-successor/PHASE_B_REQUIRED_DISCHARGE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/RequiredDischarge.lean",
  "formal-successor/PHASE_B_RESOLUTION_CARRIERS_SCHEMA.json",
  "formal-successor/PHASE_B_RESOLUTION_CARRIERS_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ResolutionCarriers.lean",
  "formal-successor/PHASE_B_RESOLUTION_OUTCOME_SCHEMA.json",
  "formal-successor/PHASE_B_RESOLUTION_OUTCOME_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ResolutionOutcome.lean",
  "formal-successor/PHASE_B_INQUIRY_SOURCE_GRAMMAR_SCHEMA.json",
  "formal-successor/PHASE_B_INQUIRY_SOURCE_GRAMMAR_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/InquirySourceGrammar.lean",
  "formal-successor/PHASE_B_RESIDUAL_QUESTION_GENERATOR_SCHEMA.json",
  "formal-successor/PHASE_B_RESIDUAL_QUESTION_GENERATOR_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ResidualQuestionGenerator.lean",
  "formal-successor/PHASE_B_CHECKED_ASK_OCCURRENCE_SCHEMA.json",
  "formal-successor/PHASE_B_CHECKED_ASK_OCCURRENCE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/CheckedAskOccurrence.lean",
  "formal-successor/PHASE_B_HEAD_QUESTION_SCHEMA.json",
  "formal-successor/PHASE_B_HEAD_QUESTION_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/HeadQuestion.lean",
  "formal-successor/PHASE_B_QSUCC_OCCURRENCE_SCHEMA.json",
  "formal-successor/PHASE_B_QSUCC_OCCURRENCE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/OccurrenceIndexedQuestionSuccession.lean",
  "formal-successor/PHASE_B_QSUCC_OCCURRENCE_TYPING_SCHEMA.json",
  "formal-successor/PHASE_B_QSUCC_OCCURRENCE_TYPING_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/QuestionSuccessionTypingClaim.lean",
  "formal-successor/PHASE_B_RECIPROCAL_PROGRAM_SCHEMA.json",
  "formal-successor/PHASE_B_RECIPROCAL_PROGRAM_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/DependentReciprocalProgram.lean",
  "formal-successor/PHASE_B_HOLE_SOLVING_SCHEMA.json",
  "formal-successor/PHASE_B_HOLE_SOLVING_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/HoleSolving.lean",
  "formal-successor/PHASE_B_REPRESENTATION_SEARCH_SCHEMA.json",
  "formal-successor/PHASE_B_REPRESENTATION_SEARCH_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/RepresentationSearch.lean",
  "formal-successor/PHASE_B_PROGRAM_CORE_GRAMMAR_SCHEMA.json",
  "formal-successor/PHASE_B_PROGRAM_CORE_GRAMMAR_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ProgramCoreGrammar.lean",
  "formal-successor/PHASE_B_SOURCE_SAFE_ASK_LOWERING_SCHEMA.json",
  "formal-successor/PHASE_B_SOURCE_SAFE_ASK_LOWERING_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/SourceSafeAskLowering.lean",
  "formal-successor/PHASE_B_SOURCE_ASK_COMPILATION_SAFETY_CLAIM_SCHEMA.json",
  "formal-successor/PHASE_B_SOURCE_ASK_COMPILATION_SAFETY_CLAIM_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/SourceAskCompilationSafetyClaim.lean",
  "formal-successor/PHASE_B_SEQUENCING_COMPOSITION_SCHEMA.json",
  "formal-successor/PHASE_B_SEQUENCING_COMPOSITION_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/SequencingComposition.lean",
  "formal-successor/PHASE_B_OPERATIONAL_SEMANTICS_SCHEMA.json",
  "formal-successor/PHASE_B_OPERATIONAL_SEMANTICS_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/OperationalSemantics.lean",
  "formal-successor/PHASE_B_GUARDED_RECURRENCE_SCHEMA.json",
  "formal-successor/PHASE_B_GUARDED_RECURRENCE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/GuardedRecurrence.lean",
  "formal-successor/PHASE_B_COMPILER_ARCHITECTURE_SCHEMA.json",
  "formal-successor/PHASE_B_COMPILER_ARCHITECTURE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/CompilerArchitecture.lean",
  "formal-successor/PHASE_B_NORMALIZE_OPEN_RELATION_SCHEMA.json",
  "formal-successor/PHASE_B_NORMALIZE_OPEN_RELATION_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/NormalizeOpenRelation.lean",
  "formal-successor/PHASE_B_LOCAL_RECIPROCAL_CHART_SCHEMA.json",
  "formal-successor/PHASE_B_LOCAL_RECIPROCAL_CHART_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/LocalReciprocalChart.lean",
  "formal-successor/PHASE_B_ACTIVE_VIEW_SCHEMA.json",
  "formal-successor/PHASE_B_ACTIVE_VIEW_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ActiveView.lean",
  "formal-successor/PHASE_B_DISCHARGE_ROUTE_SCHEMA.json",
  "formal-successor/PHASE_B_DISCHARGE_ROUTE_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/DischargeRoute.lean",
  "formal-successor/PHASE_B_LLM_POSSIBILITY_SCHEMA.json",
  "formal-successor/PHASE_B_LLM_POSSIBILITY_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/LLMPossibility.lean",
  "formal-successor/PHASE_B_PROMPT_OPERATOR_SCHEMA.json",
  "formal-successor/PHASE_B_PROMPT_OPERATOR_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/PromptOperator.lean",
  "formal-successor/PHASE_B_CANONICAL_RENDERING_ELABORATION_SCHEMA.json",
  "formal-successor/PHASE_B_CANONICAL_RENDERING_ELABORATION_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/CanonicalRenderingElaboration.lean",
  "formal-successor/PHASE_B_BEHAVIORAL_COMPILER_CORRECTNESS_SCHEMA.json",
  "formal-successor/PHASE_B_BEHAVIORAL_COMPILER_CORRECTNESS_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/BehavioralCompilerCorrectness.lean",
  "formal-successor/PHASE_B_QUESTION_CONDITIONED_LLM_FIELD_SCHEMA.json",
  "formal-successor/PHASE_B_QUESTION_CONDITIONED_LLM_FIELD_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/QuestionConditionedLLMField.lean",
  "formal-successor/PHASE_B_THREE_DISTINCT_ORDERS_SCHEMA.json",
  "formal-successor/PHASE_B_THREE_DISTINCT_ORDERS_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ThreeDistinctOrders.lean",
  "formal-successor/PHASE_B_AUTHORITATIVE_ANCESTRY_SCHEMA.json",
  "formal-successor/PHASE_B_AUTHORITATIVE_ANCESTRY_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/AuthoritativeAncestry.lean",
  "formal-successor/PHASE_B_EVENT_RECORD_SCHEMA.json",
  "formal-successor/PHASE_B_EVENT_RECORD_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/EventRecord.lean",
  "formal-successor/PHASE_B_DERIVED_PAIRED_ACTUALITY_SCHEMA.json",
  "formal-successor/PHASE_B_DERIVED_PAIRED_ACTUALITY_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/DerivedPairedActuality.lean",
  "formal-successor/PHASE_B_STATE_WORKING_PRESENTATION_SCHEMA.json",
  "formal-successor/PHASE_B_STATE_WORKING_PRESENTATION_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/StateWorkingPresentation.lean",
  "formal-successor/PHASE_B_OPERATOR_OCCURRENCE_INDEX_SCHEMA.json",
  "formal-successor/PHASE_B_OPERATOR_OCCURRENCE_INDEX_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/OperatorOccurrenceIndex.lean",
  "formal-successor/PHASE_B_RECURRENT_PROBES_SCHEMA.json",
  "formal-successor/PHASE_B_RECURRENT_PROBES_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/RecurrentProbes.lean",
  "formal-successor/PHASE_B_PROBE_TRACES_SCHEMA.json",
  "formal-successor/PHASE_B_PROBE_TRACES_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/ProbeTraces.lean",
  "formal-successor/PHASE_B_FRESH_PROBE_COMPARISON_SCHEMA.json",
  "formal-successor/PHASE_B_FRESH_PROBE_COMPARISON_SURFACE.json",
  "formal/InquiryCalculus/Legacy/V20/FreshProbeComparison.lean",
  ...
  "formal/InquiryCalculus/Legacy/V20/MethodPromotion.lean",
  "formal-successor/PHASE_B_METHOD_PROMOTION.md",
  "tools/method_promotion_check.js",
...
requireContains(".github/workflows/ci.yml", [
  ...
  "node tools/phase_b_tagged_negation_frontier.js check",
  "node tools/phase_b_tagged_negation_frontier_check.js",
  "node tools/phase_b_use_specific_return_fiber.js check",
  "node tools/phase_b_use_specific_return_fiber_check.js",
  "node tools/phase_b_protected_recovery.js check",
  "node tools/phase_b_protected_recovery_check.js",
  "node tools/phase_b_source_web_recovery_profile.js check",
  "node tools/phase_b_source_web_recovery_profile_check.js",
  "node tools/phase_b_three_valued_recovery_loss_profile.js check",
  "node tools/phase_b_three_valued_recovery_loss_profile_check.js",
  "node tools/phase_b_regenerative_economy_frontier.js check",
  "node tools/phase_b_regenerative_economy_frontier_check.js",
  "node tools/phase_b_required_discharge.js check",
  "node tools/phase_b_required_discharge_check.js",
  "node tools/phase_b_resolution_carriers.js check",
  "node tools/phase_b_resolution_carriers_check.js",
  "node tools/phase_b_resolution_outcome.js check",
  "node tools/phase_b_resolution_outcome_check.js",
  "node tools/phase_b_inquiry_source_grammar.js check",
  "node tools/phase_b_inquiry_source_grammar_check.js",
  "node tools/phase_b_residual_question_generator.js check",
  "node tools/phase_b_residual_question_generator_check.js",
  "node tools/phase_b_checked_ask_occurrence.js check",
  "node tools/phase_b_checked_ask_occurrence_check.js",
  "node tools/phase_b_head_question.js check",
  "node tools/phase_b_head_question_check.js",
  "node tools/phase_b_qsucc_occurrence.js check",
  "node tools/phase_b_qsucc_occurrence_check.js",
  "node tools/phase_b_qsucc_occurrence_typing.js check",
  "node tools/phase_b_qsucc_occurrence_typing_check.js",
  "node tools/phase_b_reciprocal_program.js check",
  "node tools/phase_b_reciprocal_program_check.js",
  "node tools/phase_b_hole_solving.js check",
  "node tools/phase_b_hole_solving_check.js",
  "node tools/phase_b_representation_search.js check",
  "node tools/phase_b_representation_search_check.js",
  "node tools/phase_b_program_core_grammar.js check",
  "node tools/phase_b_program_core_grammar_check.js",
  "node tools/phase_b_source_safe_ask_lowering.js check",
  "node tools/phase_b_source_safe_ask_lowering_check.js",
  "node tools/phase_b_source_ask_compilation_safety_claim.js check",
  "node tools/phase_b_source_ask_compilation_safety_claim_check.js",
  "node tools/phase_b_sequencing_composition.js check",
  "node tools/phase_b_sequencing_composition_check.js",
  "node tools/phase_b_operational_semantics.js check",
  "node tools/phase_b_operational_semantics_check.js",
  "node tools/phase_b_guarded_recurrence.js check",
  "node tools/phase_b_guarded_recurrence_check.js",
  "node tools/phase_b_compiler_architecture.js check",
  "node tools/phase_b_compiler_architecture_check.js",
  "node tools/phase_b_normalize_open_relation.js check",
  "node tools/phase_b_normalize_open_relation_check.js",
  "node tools/phase_b_local_reciprocal_chart.js check",
  "node tools/phase_b_local_reciprocal_chart_check.js",
  "node tools/phase_b_active_view.js check",
  "node tools/phase_b_active_view_check.js",
  "node tools/phase_b_discharge_route.js check",
  "node tools/phase_b_discharge_route_check.js",
  "node tools/phase_b_llm_possibility.js check",
  "node tools/phase_b_llm_possibility_check.js",
  "node tools/phase_b_prompt_operator.js check",
  "node tools/phase_b_prompt_operator_check.js",
  "node tools/phase_b_canonical_rendering_elaboration.js check",
  "node tools/phase_b_canonical_rendering_elaboration_check.js",
  "node tools/phase_b_behavioral_compiler_correctness.js check",
  "node tools/phase_b_behavioral_compiler_correctness_check.js",
  "node tools/phase_b_question_conditioned_llm_field.js check",
  "node tools/phase_b_question_conditioned_llm_field_check.js",
  "node tools/phase_b_three_distinct_orders.js check",
  "node tools/phase_b_three_distinct_orders_check.js",
  "node tools/phase_b_authoritative_ancestry.js check",
  "node tools/phase_b_authoritative_ancestry_check.js",
  "node tools/phase_b_event_record.js check",
  "node tools/phase_b_event_record_check.js",
  "node tools/phase_b_derived_paired_actuality.js check",
  "node tools/phase_b_derived_paired_actuality_check.js",
  "node tools/phase_b_state_working_presentation.js check",
  "node tools/phase_b_state_working_presentation_check.js",
  "node tools/phase_b_operator_occurrence_index.js check",
  "node tools/phase_b_operator_occurrence_index_check.js",
  "node tools/phase_b_recurrent_probes.js check",
  "node tools/phase_b_recurrent_probes_check.js",
  "node tools/phase_b_probe_traces.js check",
  "node tools/phase_b_probe_traces_check.js",
  "node tools/phase_b_fresh_probe_comparison.js check",
  ...
  "node tools/method_promotion_check.js",
