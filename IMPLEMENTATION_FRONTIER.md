...
Construct every exact canonical-question alternative as an overcomplete typed carrier, then
contrast it with answer sets, valid-completion predicates, probes, programs, and omission. Contract
only after exact source regeneration and retained obligations distinguish the smallest question surface.

## Prohibitions at this boundary

- Do not treat a question as an answer carrier, valid-completion predicate, probe, or program.
- Do not use an open port set alone as question authority without a typed relation occurrence.
...
On pass, retain the smallest source-regenerative canonical-question carrier, explicit source
obligations, and independent breakers, then select the next residual. On failure, preserve the
return and reopen the earliest question, answer, probe, program, or source boundary relation.
